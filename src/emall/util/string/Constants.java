...
public class Constants {
    ...
    public static final int FAIL_NUMBER = -1;

    public static final String LOGIN_EXCEPTION = "username and password do not match";
    public static final String ADD_ADMIN_SUCCESS_MESSAGE = "add merchant success";
    public static final String ADD_ADMIN_FAIL_MESSAGE = "add merchant fail, please try again later";
